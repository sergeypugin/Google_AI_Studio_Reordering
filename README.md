...
>[!important]
>Может показаться, что раз теперь Вы видите все аттачменты чата в папке `Attachments`, то достаточно удалить её (и из Bin в гугле тоже), и кол-во токенов в чате уменьшится. И Вы правы. ОДНАКО: чат после удаление любого аттачмента чат студии не заработает! И единственный способ будет его продолжить - это удалить руками в чате все те аттачменты, что были удалены. Ну или сделать md-заметку при помощи скрипта и работать уже с ней. Так что ни в коем случае не удаляйте аттачменты вне интерфейса студии!!!
